...
class _DealersMapPageState extends State<DealersMapPage> {
  ...
  void initState() {
    ...
    // BlocProvider.of<DealerBloc>(context)..dispatch(FetchDealers(widget.lpgmc.id));
  ...
  Marker _registerMarker(
    ...
    return Marker(
        ...
        infoWindow: InfoWindow(title: ventureName, snippet: address),
